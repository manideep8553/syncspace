...
export function WhiteboardPage() {
  ...
  useEffect(() => {
    if (document && document.type !== 'WHITEBOARD') {
      window.location.assign(`/doc/${document.id}`);
    }
  }, [document]);
  ...
  if (loading) return <Spinner label="Opening whiteboard..." />;
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Modal
        ...
        subtitle="All shapes on this board will be permanently removed."
      >
