...
import { addMemberSchema, createWorkspaceSchema, memberRoleSchema } from '../services/workspace.service.js';
...
router.patch('/:workspaceId/members/:memberId', validate({ body: memberRoleSchema }), ctrl.updateRole);
